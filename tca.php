...
$TCA['tx_orgreferences'] = array (
  ...
  'interface' => array (
    'showRecordFieldList' =>  'title, uid_extern, short, text, static_languages, static_countries, static_country_zones, location, length, recurrence, value, tx_org_tax, url, rating,'.
                              'requirements,'.
                              'subject,'.
                              'tx_orgreferences_cat, tx_orgreferences_focus, tx_orgreferences_sector, tx_orgreferences_audience, tx_orgreferences_degree, tx_orgreferences_course, tx_orgreferences_riskcycle, tx_orgreferences_type,'.
  ...
  'columns' => array (
    ...
    'tx_orgreferences_audience'  => $arr_tx_orgreferences_cat,
    'tx_orgreferences_degree'    => $arr_tx_orgreferences_cat,
    'tx_orgreferences_course'    => $arr_tx_orgreferences_cat,
    'tx_orgreferences_riskcycle' => $arr_tx_orgreferences_cat,
  ...
  'types' => array (
    '0' => array('showitem' =>  '--div--;LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences.div_references,           title, uid_extern, short, text;;;richtext[]:rte_transform[mode=ts];, static_languages, static_countries, static_country_zones, location, length, recurrence, value, tx_org_tax, url, rating,'.
                                ...
                                '--div--;LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences.div_categories,         tx_orgreferences_cat, tx_orgreferences_focus, tx_orgreferences_sector, tx_orgreferences_audience, tx_orgreferences_degree, tx_orgreferences_course, tx_orgreferences_riskcycle, tx_orgreferences_type,'.
...
$TCA['tx_orgreferences']['columns']['fe_users']['config']['MM'] =
  ...
  // Relation tx_orgreferences_audience
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['label'] =
  'LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences.tx_orgreferences_audience';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['size'] =
  5;
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['MM'] =
  'tx_orgreferences_mm_tx_orgreferences_audience';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['foreign_table'] =
  'tx_orgreferences_audience';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['foreign_table_where'] =
  'AND tx_orgreferences_audience.' . $str_store_record_conf . ' ORDER BY tx_orgreferences_audience.title';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['wizards']['add']['title'] =
  'LLL:EXT:orgreferences/locallang_db.xml:wizard.tx_orgreferences_audience.add';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['wizards']['add']['params']['table'] =
  'tx_orgreferences_audience';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['wizards']['list']['title'] =
  'LLL:EXT:orgreferences/locallang_db.xml:wizard.tx_orgreferences_audience.list';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['wizards']['edit']['title'] =
  'LLL:EXT:orgreferences/locallang_db.xml:wizard.tx_orgreferences_audience.edit';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['wizards']['list']['params']['table'] =
  'tx_orgreferences_audience';
if($bool_wizards_wo_add_and_list_for_catTables)
{
  unset($TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['wizards']['add']);
  unset($TCA['tx_orgreferences']['columns']['tx_orgreferences_audience']['config']['wizards']['list']);
}
  // Relation tx_orgreferences_audience
...
if($bool_wizards_wo_add_and_list_for_catTables)
{
  ...
  // Relation tx_orgreferences_riskcycle
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['label'] =
  'LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences.tx_orgreferences_riskcycle';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['size'] =
  5;
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['MM'] =
  'tx_orgreferences_mm_tx_orgreferences_riskcycle';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['foreign_table'] =
  'tx_orgreferences_riskcycle';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['foreign_table_where'] =
  'AND tx_orgreferences_riskcycle.' . $str_store_record_conf . ' ORDER BY tx_orgreferences_riskcycle.title';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['wizards']['add']['title'] =
  'LLL:EXT:orgreferences/locallang_db.xml:wizard.tx_orgreferences_riskcycle.add';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['wizards']['add']['params']['table'] =
  'tx_orgreferences_riskcycle';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['wizards']['list']['title'] =
  'LLL:EXT:orgreferences/locallang_db.xml:wizard.tx_orgreferences_riskcycle.list';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['wizards']['edit']['title'] =
  'LLL:EXT:orgreferences/locallang_db.xml:wizard.tx_orgreferences_riskcycle.edit';
$TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['wizards']['list']['params']['table'] =
  'tx_orgreferences_riskcycle';
if($bool_wizards_wo_add_and_list_for_catTables)
{
  unset($TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['wizards']['add']);
  unset($TCA['tx_orgreferences']['columns']['tx_orgreferences_riskcycle']['config']['wizards']['list']);
}
  // Relation tx_orgreferences_riskcycle
...
$TCA['tx_orgreferences_audience'] = array (
  'ctrl' => $TCA['tx_orgreferences_audience']['ctrl'],
  'interface' => array (
    'showRecordFieldList' =>  'title,tx_orgreferences,'.
                              'hidden'
  ),
  'feInterface' => $TCA['tx_orgreferences_audience']['feInterface'],
  'columns' => array (
    'title' => array (
      'exclude' => 0,
      'label' => 'LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences_audience.title',
      'config'  => $conf_input_30_trimRequired,
    ),
  ...
  'types' => array (
    '0' => array('showitem' =>  '--div--;LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences_audience.div_audience,   title,tx_orgreferences,'.
                                '--div--;LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences_audience.div_access,   hidden'.
                                ''),
  ),
);

  // Relation tx_orgreferences
$TCA['tx_orgreferences_audience']['columns']['tx_orgreferences']['config']['maxitems'] = 999;
unset($TCA['tx_orgreferences_degeree']['columns']['tx_orgreferences']['config']['items']);
$TCA['tx_orgreferences_audience']['columns']['tx_orgreferences']['config']['MM'] =
  'tx_orgreferences_mm_tx_orgreferences_audience';
$TCA['tx_orgreferences_audience']['columns']['tx_orgreferences']['config']['MM_opposite_field'] =
  'tx_orgreferences_audience';
  // Relation tx_orgreferences
  // tx_orgreferences_audience
...
$TCA['tx_orgreferences_riskcycle'] = array (
  'ctrl' => $TCA['tx_orgreferences_riskcycle']['ctrl'],
  'interface' => array (
    'showRecordFieldList' =>  'title,tx_orgreferences,'.
                              'hidden'
  ),
  'feInterface' => $TCA['tx_orgreferences_riskcycle']['feInterface'],
  'columns' => array (
    'title' => array (
      'exclude' => 0,
      'label' => 'LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences_riskcycle.title',
      'config'  => $conf_input_30_trimRequired,
    ),
    'tx_orgreferences' => $TCA['tx_orgreferences_cat']['columns']['tx_orgreferences'],
    'hidden'          => $conf_hidden,
  ...
  'types' => array (
    '0' => array('showitem' =>  '--div--;LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences_riskcycle.div_riskcycle,   title,tx_orgreferences,'.
                                '--div--;LLL:EXT:orgreferences/locallang_db.xml:tx_orgreferences_riskcycle.div_access,   hidden'.
                                ''),
  ),
);

  // Relation tx_orgreferences
$TCA['tx_orgreferences_riskcycle']['columns']['tx_orgreferences']['config']['maxitems'] = 999;
unset($TCA['tx_orgreferences_degeree']['columns']['tx_orgreferences']['config']['items']);
$TCA['tx_orgreferences_riskcycle']['columns']['tx_orgreferences']['config']['MM'] =
  'tx_orgreferences_mm_tx_orgreferences_riskcycle';
$TCA['tx_orgreferences_riskcycle']['columns']['tx_orgreferences']['config']['MM_opposite_field'] =
  'tx_orgreferences_riskcycle';
  // Relation tx_orgreferences
  // tx_orgreferences_riskcycle
